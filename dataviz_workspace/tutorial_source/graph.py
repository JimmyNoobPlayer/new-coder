...
FILE = "../data/sample_sfpd_incident_all.csv"
...
def visualize_days(raw_file):
    """visualize the data in the csv by number of incidents on each day of week"""

    #read data from csv file
    parsed_file = parse.parse(FILE, ",")
    #count incidents for each day of the week
    counts = Counter(item["DayOfWeek"] for item in parsed_file)
    sorted_counts = [counts["Monday"], counts["Tuesday"], counts["Wednesday"], counts["Thursday"], counts["Friday"], counts["Saturday"]]

    
    #create info needed for the graph display (day of week abbreviations)
...
##    data_file = parse.parse(raw_file, ",")
